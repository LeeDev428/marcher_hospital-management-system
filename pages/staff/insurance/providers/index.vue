...
import InsuranceProvidersTable from "../components/InsuranceProviderTable.vue"
...
onMounted(() => {
  breadcrumbsStore.setBreadcrumbs([
    ...
    { label: "Insurance Providers", link: "/insurance/providers" },
  ])
})
</script>

<template>
  <NuxtLayout name="staff" title="Insurance">
    <div class="h-full w-full flex flex-col gap-4 bg-white p-4 rounded-lg">
      <div class="w-full flex gap-2 justify-between">
        ...
        <div class="flex gap-2">
          <NuxtLink to="/insurance">
            <Button variant="outline">
              <Icon name="mdi:arrow-left" />
              Back
            </Button>
          </NuxtLink>
          <NuxtLink to="/insurance/providers/new">
