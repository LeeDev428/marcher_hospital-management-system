<template>
  <NuxtLayout name="billing-staff" title="Billing Transactions">
    <div class="p-6 space-y-6">
      <!-- Header -->
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold text-gray-900">Billing Transactions</h1>
          <p class="text-sm text-gray-600 mt-1">Manage patient billing transactions and payments</p>
        </div>
...
import CreateBillDialog from '@/pages/admin/billing/components/CreateBillDialog.vue'
import ViewBillDialog from '@/pages/admin/billing/components/ViewBillDialog.vue'
import AddItemsDialog from '@/pages/admin/billing/components/AddItemsDialog.vue'
